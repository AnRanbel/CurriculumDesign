package cn.edu.ctbu.curtaincontroller.view;

import android.view.View.OnTouchListener;
import cn.edu.ctbu.curtaincontroller.R;
import cn.edu.ctbu.curtaincontroller.tools.BaseTools;
...
public class CurtainView extends RelativeLayout implements OnTouchListener{
	...
	private void init(Context context) {
		...
		img_curtain_ad = (ImageView)view.findViewById(R.id.img_curtain);
